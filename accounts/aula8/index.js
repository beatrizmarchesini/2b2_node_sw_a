...
function removeAmoun(accountName, amount){
    const accountData = getAccount(accountName)

    if(amount){
        console.log(
            chalk.bgRed.black9('Ocorreu um erro, tente novamente mais tarde')
        )
            return withdraw()
    }
    ...
    if(accountData.balance < amount){
        console.log(
            chalk.bgRed.black('Valor Indisposinivel')
        )
    }
    ...
    console.log(
        chalk.green(`Foi sacada: R$ ${amount} da conta, saldo: R$ ${accountData.balance}.`)
    )
}